...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  // default variables
  mainLinks: document.querySelectorAll('[data-balance]'),
  mainTable: document.querySelector('.balance-list')
});
...
/* harmony import */ var _vendor_nouislider__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./vendor/nouislider */ "./source/js/vendor/nouislider.js");
/* harmony import */ var _vendor_nouislider__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_vendor_nouislider__WEBPACK_IMPORTED_MODULE_4__);
...
/***/ "./source/js/components/btnTable.js":
/*!******************************************!*\
  !*** ./source/js/components/btnTable.js ***!
  \******************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
if (mainTable) {
  mainLinks.forEach(function (link) {
    link.addEventListener('click', function (e) {
      e.preventDefault();
      (0,_functions_customFunctions__WEBPACK_IMPORTED_MODULE_1__.addCustomClass)(mainTable, 'active');
    });
  });
}
...
if (select.length) {
  select.forEach(item => {
    ...
    item.addEventListener("click", e => {
      ...
      item.querySelectorAll(`.select__wrapp [data-id]`).forEach(function (item) {
        item.style.display = "flex";
      });
      item.querySelector(`.select__wrapp [data-id='${selectInut.getAttribute("value")}']`).style.display = "none";
